...
/**
 * @fileoverview Unit tests for the Screen class.
 */
export var ScreenTests = new TestManager.Suite('ScreenTests');
export default ScreenTests;

/**
 * Clear out the current document and create a new Screen object for
 * testing.
 *
 * Called before each test case in this suite.
 */
ScreenTests.prototype.preamble = function(result, cx) {
...
/**
 * Test the push and pop functionality of the Screen.
 */
ScreenTests.addTest('push-pop', function(result, cx) {
    // Push one at a time.
    var i;
    var ary = [];
    for (i = 0; i < 10; i++) {
...
/**
 * Test the unshift and shift functionality of the Screen.
 */
ScreenTests.addTest('unshift-shift', function(result, cx) {
 ...
 */
ScreenTests.addTest('cursor-movement', function(result, cx) {
    var ary = [];
 ...
 */
ScreenTests.addTest('delete-chars', function(result, cx) {
 ...
 */
ScreenTests.addTest('insert', function(result, cx) {
    ...
    var ws = util.string.getWhitespace(this.screen.getWidth());
    ...
    var i;
    for (i = 0; i < wideCharString.length; i++) {
 ...
 */
ScreenTests.addTest('overwrite', function(result, cx) {
    var ary = [];
