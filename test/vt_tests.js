 ...
 */
export var VTTests = new TestManager.Suite('VTTests');
export default VTTests;

VTTests.prototype.setup = function(cx) {
  this.setDefaults(cx,
 ...
 */
VTTests.prototype.preamble = function(result, cx) {
 ...
 */
VTTests.prototype.postamble = function(result, cx) {
 ...
 * actual test.
 */
VTTests.addTest = function(name, callback) {
 ...
 */
VTTests.addTest('sanity', function(result, cx) {
 ...
 * characters.
 */
VTTests.addTest('utf8', function(result, cx) {
 ...
 */
VTTests.addTest('cursor-relative', function(result, cx) {
 ...
 */
VTTests.addTest('cursor-absolute', function(result, cx) {
    this.terminal.interpret('line 1\r\nline 2\r\nline 3');
 ...
 */
VTTests.addTest('line-position', function(result, cx) {
    this.terminal.interpret('line 1\r\nline 2\r\nline 3');
 ...
 * received.
 */
VTTests.addTest('partial-sequence', function(result, cx) {
    this.terminal.interpret('line 1\r\nline 2\r\nline three');
 ...
 */
VTTests.addTest('double-sequence', function(result, cx) {
 ...
 */
VTTests.addTest('8-bit-control', function(result, cx) {
    var title = null;
 ...
 */
VTTests.addTest('unterminated-sequence', function(result, cx) {
    var title = null;
    this.terminal.setWindowTitle = function(t) {
      // Set a default title so we can catch the potential for this function
      // to be called on accident with no parameter.
...
VTTests.addTest('dec-screen-test', function(result, cx) {
...
VTTests.addTest('newlines-1', function(result, cx) {
...
VTTests.addTest('newlines-2', function(result, cx) {
 ...
 */
VTTests.addTest('tabs', function(result, cx) {
 ...
 * Test terminal reset.
 */
VTTests.addTest('reset', function(result, cx) {
    this.terminal.interpret(
 ...
 */
VTTests.addTest('erase-left', function(result, cx) {
    this.terminal.interpret('line one\r\noooooooo\r\nline three');
 ...
 */
VTTests.addTest('erase-left-widechar', function(result, cx) {
    this.terminal.interpret(
 ...
 */
VTTests.addTest('erase-right', function(result, cx) {
    this.terminal.interpret('line one\r\nline XXXX\r\nline three');
    this.terminal.interpret('\x1b[5D\x1b[A' +
                            '\x1b[0Ktwo');
 ...
 */
VTTests.addTest('erase-right-widechar', function(result, cx) {
    this.terminal.interpret(
        '\xe7\xac\xac\xe4\xb8\x80\xe8\xa1\x8c\r\n' +
        '\xe7\xac\xac\xe4\xba\x8c\xe8\xa1\x8c\r\n' +
        '\xe7\xac\xac\xe4\xb8\x89\xe8\xa1\x8c');
 ...
 */
VTTests.addTest('erase-line', function(result, cx) {
    this.terminal.interpret('line one\r\nline twoo\r\nline three');
    this.terminal.interpret('\x1b[5D\x1b[A' +
                            '\x1b[2Ktwo');
 ...
 */
VTTests.addTest('erase-above', function(result, cx) {
    this.terminal.interpret('line one\r\noooooooo\r\nline three');
    this.terminal.interpret('\x1b[5D\x1b[A' +
                            '\x1b[1Jtw');
 ...
 */
VTTests.addTest('erase-all', function(result, cx) {
    this.terminal.interpret('line one\r\nline XXXX\r\nline three');
    this.terminal.interpret('\x1b[5D\x1b[A' +
                            '\x1b[2Jtwo');
 ...
 */
VTTests.addTest('erase-below', function(result, cx) {
    this.terminal.interpret('line one\r\nline XXXX\r\nline three');
    this.terminal.interpret('\x1b[5D\x1b[A' +
                            '\x1b[0Jtwo');
 ...
 */
VTTests.addTest('erase-char', function(result, cx) {
    this.terminal.interpret('line one\r\nline XXXX\r\nline three');
    this.terminal.interpret('\x1b[5D\x1b[A' +
                            '\x1b[4Xtwo');

    var text = this.terminal.getRowsText(0, 3);
    // See TODO in Terminal.prototype.eraseToRight for the extra space.
    result.assertEQ(text,
                    'line one\n' +
                    'line two\n' +
                    'line three');
 ...
 */
VTTests.addTest('insert-line', function(result, cx) {
 ...
 */
VTTests.addTest('insert-lines', function(result, cx) {
 ...
 */
VTTests.addTest('insert-toomany-lines', function(result, cx) {
 ...
 */
VTTests.addTest('delete-line', function(result, cx) {
    this.terminal.interpret('line one\r\nline two\r\n' +
                            'XXXXXXXX\r\n' +
                            'line XXXXX');
 ...
 */
VTTests.addTest('delete-lines', function(result, cx) {
    this.terminal.interpret('line one\r\nline two\r\n' +
                            'XXXXXXXX\r\nXXXXXXXX\r\n' +
                            'line XXXXX');
 ...
 */
VTTests.addTest('insert-space', function(result, cx) {
    this.terminal.interpret('line one\r\nlinetwo\r\nline three');
 ...
 */
VTTests.addTest('insert-spaces', function(result, cx) {
    this.terminal.interpret('line one\r\nlinetwo\r\nline three');
 ...
 */
VTTests.addTest('delete-chars', function(result, cx) {
    this.terminal.interpret('line one\r\nline XXXX\r\nline three');
 ...
 */
VTTests.addTest('delete-toomany', function(result, cx) {
    this.terminal.interpret('line one\r\nline XXXX\r\nline three');
 ...
 */
VTTests.addTest('scroll-up', function(result, cx) {
    this.terminal.interpret('\r\n\r\nline one\r\nline two\r\nline XXXXX');
 ...
 */
VTTests.addTest('scroll-down', function(result, cx) {
    this.terminal.interpret('line one\r\nline two\r\nline XXXXX\r\n');
 ...
 */
VTTests.addTest('line-position-absolute', function(result, cx) {
 ...
 */
VTTests.addTest('device-attributes', function(result, cx) {
    var resultString;
 ...
 */
VTTests.disableTest('clear-line-tabstops', function(result, cx) {
    '[0g';
  });
 ...
 */
VTTests.disableTest('clear-all-tabstops', function(result, cx) {
    '[3g';
  });
 ...
 */
VTTests.addTest('color-change', function(result, cx) {
    this.terminal.interpret('\x1b[mplain....... \x1b[0;36mHi\r\n' +
                            '\x1b[mitalic...... \x1b[3;36mHi\r\n' +
                            '\x1b[mbright...... \x1b[0;96mHi\r\n' +
                            '\x1b[mbold........ \x1b[1;36mHi\r\n' +
                            '\x1b[mbold-bright. \x1b[1;96mHi\r\n' +
                            '\x1b[mbright-bold. \x1b[96;1mHi');
    ...
    for (var i = 0; i < 6; i++) {
      ...
      var isBold = !!row.childNodes[1].style.fontWeight;
      result.assert(isBold == (i > 2), 'i: ' + i);
      result.assertEQ(
...
VTTests.addTest('bold-as-bright', function(result, cx) {
...
VTTests.addTest('disable-bold-as-bright', function(result, cx) {
    var attrs = this.terminal.primaryScreen_.textAttributes;
    var alt_attrs = this.terminal.alternateScreen_.textAttributes;
 ...
 */
VTTests.addTest('status-report', function(result, cx) {
    var resultString;
    this.terminal.io.sendString = function (str) { resultString = str };
 ...
 */
VTTests.addTest('mode-bits', function(result, cx) {
 ...
 */
VTTests.addTest('true-color-mode', function(result, cx) {
    function getEscape(row, fg) {
      return  '\x1b[' + (!!fg ? 38 : 48) + ';2;' + row[1] + ';' +
              row[2] + ';' + row[3] + 'm';
    }
    ...
    for (var i = 0; i < 6; i++) {
      ...
      for (var j = 0; j < 6; j++ ) {
        this.terminal.interpret('\x1b[mTrue Color Test ' +
 ...
 */
VTTests.disableTest('origin-mode', function(result, cx) {
  });

/**
 * Test insert/overwrite mode.
 */
VTTests.addTest('insert-mode', function(result, cx) {
    // Should be off by default.
    result.assertEQ(this.terminal.options_.insertMode, false);
 ...
 */
VTTests.addTest('wraparound-mode-on', function(result, cx) {
...
VTTests.addTest('wraparound-mode-off', function(result, cx) {
    this.terminal.interpret('\x1b[?7l');
    result.assertEQ(this.terminal.options_.wraparound, false);
 ...
 */
VTTests.addTest('insert-wrap', function(result, cx) {
    // Should be on by default.
    result.assertEQ(this.terminal.options_.wraparound, true);

    this.terminal.interpret('' + // Insert off, wrap on (default).
                            '\x1b[15GAAAA\x1b[1GXX\r\n' +
                            '\x1b[4h\x1b[?7l' +  // Insert on, wrap off.
                            '\x1b[15GAAAA\x1b[1GXX\r\n' +
                            '\x1b[4h\x1b[?7h' +  // Insert on, wrap on.
                            '\x1b[15GAAAA\x1b[1GXX\r\n' +
                            '\x1b[4l\x1b[?7l' +  // Insert off, wrap off.
                            '\x1b[15GAAAA\x1b[1GXX');
 ...
 */
VTTests.addTest('long-wrap', function(result, cx) {
    var str = '';
 ...
 */
VTTests.addTest('reverse-wrap', function(result, cx) {
 ...
 * escape sequences.
 */
VTTests.addTest('cursor-overflow', function(result, cx) {
    // Should be on by default.
    result.assertEQ(this.terminal.options_.wraparound, true);
    ...
    // See Terminal.prototype.eraseToRight.
...
VTTests.addTest('alternate-screen', function(result, cx) {
 ...
 */
VTTests.addTest('OSC-52', function(result, cx) {
    // Mock this out since we can't document.execCommand from the
    // test harness.
    var old_cCSTC = util.dom.copySelectionToClipboard;
    util.dom.copySelectionToClipboard = function(document) {
      var s = document.getSelection();
      result.assertEQ(s.anchorNode.textContent, 'copypasta!');
      util.dom.copySelectionToClipboard = old_cCSTC;
      result.pass();
    };
 ...
 * calls.
 */
VTTests.addTest('OSC-52-big', function(result, cx) {
    // Mock this out since we can't document.execCommand from the
    // test harness.
    var old_cCSTC = util.dom.copySelectionToClipboard;
    util.dom.copySelectionToClipboard = function(document) {
...
VTTests.addTest('OSC-4', function(result, cx) {
    var resultString;
 ...
 */
VTTests.addTest('DECSCUSR, cursor shapes', function(result, cx) {
    result.assertEQ(this.terminal.getCursorShape(),
                    struct.cursorShape.BLOCK);
    result.assertEQ(this.terminal.options_.cursorBlink, false);
...
VTTests.addTest('bracketed-paste', function(result, cx) {
    var resultString;
    this.terminal.io.sendString = function (str) { resultString = str };
...
VTTests.addTest('fullscreen', function(result, cx) {
    ...
    setTimeout(function() {
        for (var i = 0; i < 1000; i++) {
          ...
          self.terminal.interpret('Line ' + util.string.zpad(i, 3) + ': ' +
                                  util.string.getWhitespace(indent) + '*\n');
        }
