...
import MockRowProvider from 'test/mock_row_provider';

export var ScrollPortTests = new TestManager.Suite('ScrollPortTests');
export default ScrollPortTests;

ScrollPortTests.prototype.setup = function(cx) {
  this.setDefaults(cx,
 ...
 */
ScrollPortTests.prototype.preamble = function(result, cx) {
 ...
 */
ScrollPortTests.addTest('basic-scroll', function(result, cx) {
 ...
 */
ScrollPortTests.addTest('scroll-selection', function(result, cx) {
 ...
 */
ScrollPortTests.addTest('select-all', function(result, cx) {
 ...
 */
ScrollPortTests.addTest('fullscreen', function(result, cx) {
    var document = cx.window.document;
