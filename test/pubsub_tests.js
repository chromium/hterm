...
var PubSubTests = new TestManager.Suite('hterm.PubSubTests');

/**
 * Test that the appropriate methods are added to a PubSub target object.
 */
PubSubTests.addTest('methods', function(result, cx) {
    var obj = {};
 ...
 */
PubSubTests.addTest('publish-order', function(result, cx) {
    var callbackCount = 0;
 ...
 */
PubSubTests.addTest('parameter', function(result, cx) {
    var expected = {};
 ...
 */
PubSubTests.addTest('forever-alone', function(result, cx) {
 ...
 * notifications.
 */
PubSubTests.addTest('exception', function(result, cx) {
    var calledFoo = false;
    var calledBar = false;
    var calledLast = false;
